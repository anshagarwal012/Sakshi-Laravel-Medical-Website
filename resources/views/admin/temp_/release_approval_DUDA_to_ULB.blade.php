            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-center text-primary m-0">Fund Release Duda To ULB</h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($data[3] as $key => $item)
                                        @if ($item['suda_decision'] == 1)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($item['duda_demand_approve'] != 1 )
                                                        <a class="btn btn-primary" href="/api/release_approval_DUDA_to_ULB/1/{{ $item['fd_id'] }}">Approved</a>
                                                    @else
                                                    Approved
                                                    {{-- /release_approval_DUDA_to_ULB/{status}/{id} --}}
                                                    @endif
                                                </td>
                                            </tr>
                                        @endif
