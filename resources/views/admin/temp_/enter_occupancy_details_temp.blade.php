...
@section('title')
    Shelter Home Occupancy Entry Temporary
@endsection
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-center text-primary m-0">Shelter Home Occupancy Entry Temporary</h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-md-8">
                                                    <input class="form-control" type="number" required
                                                        name="self_transgender"
                                                        value="{{ $edit_data->self_transgender }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form class="mb-4" action="{{ url()->current() }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class=" row">
                                                ...
                                                <div class="col-md-8 d-flex justify-content-between  align-self-center">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" checked name="Structure" type="radio"
                                                            required value="TEMPORARY">
                                                        <label class="form-check-label">
                                                            TEMPORARY
                                                        </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3 row">
                                                <label for="example-date-input"
                                                    class="col-md-4 col-form-label">Run By</label>
                                                <div class="col-md-8">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3 row">
                                                <label for="example-date-input"
                                                    class="col-md-4 col-form-label">Officer</label>
                                                <div class="col-md-8">
