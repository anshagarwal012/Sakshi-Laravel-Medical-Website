...
@section('title')
    Occupancy Details Edit or Delete
@endsection
@section('css')
    <!-- plugin css -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-center text-primary m-0">Occupancy Details Edit or Delete</h3>
                    </div>
                    @if (session('success'))
                        <script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-date-input" class="col-md-4 col-form-label">From Date
                                                :</label>
                                            <div class="">
                                                <input class="form-control" type="text" id="min" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-date-input" class="col-md-4 col-form-label">To Date
                                                :</label>
                                            <div class="">
                                                <input class="form-control" type="text" id="max" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php
                                                    ...
                                                    $firstDate = \Carbon\Carbon::parse($createdAt);
                                                    $secondDate = \Carbon\Carbon::parse($currentDate);
                                                @endphp
                                                @if (!$firstDate->diffInDays($secondDate))
                                                    @if (!$item['approve'])
                                                        <div class="row">
