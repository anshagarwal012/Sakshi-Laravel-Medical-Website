            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-center text-primary m-0">Demand Approval And Release</h3>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data[3] as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item['duda_approve'] != 1 || $item['duda_approve'] == null)
                                                    <button type="button"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approval of ULB demand by Duda</h5>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-12">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-7">
                                            <input type="date" class="form-control" required name="duda_date" value="{{ date('Y-m-d') }}" />
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <div class="col-md-5">
                                        ...
                                        Structure</label> --}}
                                                <div
                                                    ...
                                                    <div class="form-check ">
                                                        <input class="form-check-input" name="duda_approve"
                                    ...
                                    <div class="mb-3 row letter_upload">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control" type="file" name="duda_demand_letter"
                                        ...
                                        <div class="col-md-7">
                                            <input id="formletter" class="form-control" type="text" name="duda_letter_number" required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-7">
                                            <textarea class="form-control" name="duda_remarks" required id="" cols="10" rows="10"
    ...
    @section('scripts')
        <script>
            ...
            $(document).on('click','.create_pass', function(e) {
                ...
                if(type == 'utilize'){
                    $('#formFile').attr('name', 'duda_utilize_letter');
                    $('.change_letter_text').text('Upload UC')
                }else{
                    $('#formFile').attr('name', 'duda_demand_letter');
                    $('.change_letter_text').text('Upload Demand Letter')
                }
            })

            $('input[name="duda_approve"]').change(function() {
                if ($(this).val() === '1') {
