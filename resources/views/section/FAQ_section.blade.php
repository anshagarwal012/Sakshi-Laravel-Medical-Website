            ...
            <div class="col-lg-6">
                <div class="images_group_widget">
                    <ul class="unordered_list">
                        <li>
                            <img src="assets/images/about/as1.jpg" alt="Talking Minds - Psychotherapist Site Template">
                            <!--img src="" alt="Talking Minds - Psychotherapist Site Template"-->
                        </li>
                        <li>
                            {{-- <img src="" alt="Talking Minds - Psychotherapist Site Template"> --}}
                            <img src="assets/images/about/as2.jpg" alt="Talking Minds - Psychotherapist Site Template">
                        </li>
                    </ul>
                </div>
            </div>
