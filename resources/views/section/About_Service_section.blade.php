            ...
            <div class="col-lg-6 order-lg-last">
                <div class="images_group_widget">
                    <ul class="unordered_list">
                        <li>
                            <img src="assets/images/about/2.jpg" alt="Handle with Ease">
                            <img src="assets/images/about/5.jpg" alt="Handle with Ease">
                        </li>
                        <li>
                            <img src="assets/images/about/6.jpg" alt="Handle with Ease">
                            <img src="assets/images/about/8.jpg" alt="Handle with Ease">
                        </li>
                    </ul>
                </div>
            </div>
