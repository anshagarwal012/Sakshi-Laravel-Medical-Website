            ...
            <div class="carousel_2col row" data-slick='{"arrows":false}'>
                <div class="carousel_item col-">
                    <div class="testimonial_item">
                        ...
                        <p class="mb-0">
                            Lorem Ipsum is simply dummy text of the printing and typesetting text industry. Lorem Ipsum
                            has been the industry's standard dumm ever since the 1500s, when an unknown printer took a
                ...
                <div class="carousel_item col-">
                    <div class="testimonial_item">
                        ...
                        <p class="mb-0">
                            ...
                            galley of type text of the printing and typesetting industry.
                        </p>
                    </div>
                </div>
                <div class="carousel_item col-">
