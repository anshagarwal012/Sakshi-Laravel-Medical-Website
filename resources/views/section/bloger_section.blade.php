<section class="blog_section  p-19">
    <div class="container">
                ...
                <div class="blog_item">
                    <div class="blog_image">
                        <a class="blog_image_wrap" href="blog_details.html">
                            <img src="assets/images/blogs/blog_image_1-min.jpg"
                    ...
                    <div class="blog_content">
                        ...
                        <p>
                            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Sunt in similique
                            culpa qui officia deserunt.
                        </p>
                        <a class="btn-link" href="/blogs">
