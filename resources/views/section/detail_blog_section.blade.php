        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="details_image">
                    <img src="assets/images/blogs/blog_details_image_1-min.jpg"
                ...
                <div class="details_content">
                    ...
                    <blockquote>
                        ...
                        <div class="quote_content">
                            <span class="d-block">
                                Sed ut perspiciatis unde omnis iste — natus Sit totam error rem voluptatem accusantium
                                doloremque laudantium, aperiam, eaque ipsa quae.
                            </span>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 col-sm-6">
                            <div class="details_image m-0">
                                <img src="assets/images/blogs/blog_details_image_2-min.jpg"
                                    alt="Talking Minds - Psychotherapist Site Template">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <div class="details_image m-0">
                                <img src="assets/images/blogs/blog_details_image_3-min.jpg"
                                    alt="Talking Minds - Psychotherapist Site Template">
                            </div>
                        </div>
                    </div>
                ...
                <div class="blog_post_author">
                    <div class="author_image">
                        <img src="assets/images/meta/author_image_3-min.png"
                            alt="Talking Minds - Psychotherapist Site Template">
                    </div>
                    <div class="author_content">
                        ...
                        <p class="mb-0">
                            Phasellus viverra nulla ut metus varius laoreet. Quisque Nullam quis ante. Etiam sit amet
                            orci eget eros tincidunt. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum.
                            Aenean imperdiet.
                        </p>
                    </div>
                </div>
                    ...
                    <ul class="comment_list_wrap unordered_list_block">
                            ...
                            <div class="comment_item">
                                <div class="author_box">
                                    <div class="author_box_image">
                                        <img src="assets/images/meta/author_image_1.png"
                                ...
                                <p class="mb-md-0">
                                    ...
                                    vel, luctus pulvinar, hendrerit id, lorem. Nam eget dui. Etiam rhoncus.
                                </p>
                            ...
                            <ul class="comment_list_wrap unordered_list_block">
                                <li>
                                    <div class="comment_item">
                                        ...
                                        <p class="mb-md-0">
                                            ...
                                            Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Nam eget
                                            dui. Etiam rhoncus.
                                        </p>
                                        <a class="btn_reply" href="#!">
                                            <span class="btn_icon">
                                ...
                                <li>
                                    <div class="comment_item">
                                        <div class="author_box">
                                            <div class="author_box_image">
                                                <img src="assets/images/meta/author_image_2.png"
                                                    alt="Reviewer Image - Talking Minds - Psychotherapist Site Template">
                                            </div>
                                            <div class="author_box_content">
                        ...
                        <li>
                            <div class="comment_item">
                                <div class="author_box">
                                    <div class="author_box_image">
                                        <img src="assets/images/meta/author_image_4.png"
                                            alt="Reviewer Image - Talking Minds - Psychotherapist Site Template">
                                    </div>
                                    <div class="author_box_content">
